...
public class Top5Employer  extends Configured implements Tool{
	 //Map class
	   ...
	   public static class MapClass extends Mapper<LongWritable,Text,Text,Text>
	   {
	      public void map(LongWritable key, Text value, Context context)
	      {
	         try{
	            ...
	            String employer = str[2].trim();
	            String year = str[7].trim();
	            context.write(new Text(employer), new Text(year));
	   ...
	   public static class ReduceClass extends Reducer<Text,Text,Text,Text>
	   {
		   String nYear = ""; 
		    ...
		    String employer = "";
		    private Map<Integer,String> output2011Map = new TreeMap<Integer,String>(Collections.reverseOrder());
		    private Map<Integer,String> output2012Map = new TreeMap<Integer,String>(Collections.reverseOrder());
		    private Map<Integer,String> output2013Map = new TreeMap<Integer,String>(Collections.reverseOrder());
		    private Map<Integer,String> output2014Map = new TreeMap<Integer,String>(Collections.reverseOrder());
		    private Map<Integer,String> output2015Map = new TreeMap<Integer,String>(Collections.reverseOrder());
		    private Map<Integer,String> output2016Map = new TreeMap<Integer,String>(Collections.reverseOrder());

	      public void reduce(Text key, Iterable <Text> values, Context context) throws IOException, InterruptedException
	      {
	         int count = 0;
	         employer = key.toString();
	         for (Text val : values)
	         {
	        	 count++; 
	         ...
	         if(nYear.equals("2011"))
	         {
	        	 if(output2011Map.containsKey(count))
	        	 {
		     		...
		     		output2011Map.put(count, employer);
	         }
	        	 ...
	        	 if(output2012Map.containsKey(count))
	        	 {
		     		...
		     		output2012Map.put(count, employer);
	        	 ...
	        	 if(output2013Map.containsKey(count))
	        	 {
		     		...
		     		output2013Map.put(count, employer);
	        	 ...
	        	 if(output2014Map.containsKey(count))
	        	 {
		     		...
		     		output2014Map.put(count, employer);
	        	 ...
	        	 if(output2015Map.containsKey(count))
	        	 {
		     		...
		     		output2015Map.put(count, employer);
         	...
         	else
         	{
	        	 if(output2016Map.containsKey(count))
	        	 {
		     		...
		     		output2016Map.put(count, employer);
      ...
      private void printMapOutput( String year, Context context) throws IOException, InterruptedException{
	   ...
	   public int run(String[] arg) throws Exception
	   {
		  ...
		  job.setJobName("Top 5 Employer filing maximum petitions");
      ...
      job.setReducerClass(ReduceClass.class);
	   ...
	   {
	      ToolRunner.run(new Configuration(), new Top5Employer(),ar);
	      System.exit(0);
	   }
